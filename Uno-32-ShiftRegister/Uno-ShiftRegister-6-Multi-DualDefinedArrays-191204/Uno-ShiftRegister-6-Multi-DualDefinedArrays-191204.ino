...
//blinks the whole register based on the number of times you want to blink "n" and the pause
//between them "d" starts with a moment of darkness to make sure the first blink
